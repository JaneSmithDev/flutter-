...
import 'package:home/signup.dart';  // Adjust the import path based on your project structure
        ...
        child: Column(
          children: <Widget>[
            ...
            Padding(
              ...
              child: Column(
                children: <Widget>[
                  SizedBox(height: 20),  // To prevent overflow with AppBar
                  FadeInUp(
                    duration: Duration(milliseconds: 1200),
                    child: Text(
                      "Login",
                  ...
                  SizedBox(height: 20), // Space between button and "Sign up" link
                  FadeInUp(
